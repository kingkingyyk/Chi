...
public class FrameSpecialScheduleManagementContextMenu extends FrameContextMenu {
	...
	public FrameSpecialScheduleManagementContextMenu (FrameSpecialScheduleManagement m) {
		...
		newMenu.addActionListener(new ActionListener() {
			@Override public void actionPerformed(ActionEvent arg0) {FrameSpecialScheduleManagementActions.add();}
		});
		
		this.toggleMenu=addMenuItem("Toggle Status","ActuatorIcon","SPACE");
		toggleMenu.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {FrameSpecialScheduleManagementActions.toggle(m);}
		});
		
		this.editMenu=addMenuItem("Edit...","EditIcon","ENTER");
		editMenu.addActionListener(new ActionListener() {
			@Override public void actionPerformed(ActionEvent arg0) {FrameSpecialScheduleManagementActions.edit(m);}
		});
		
		this.deleteMenu=addMenuItem("Delete...","DeleteIcon","DELETE");
		deleteMenu.addActionListener(new ActionListener() {
			@Override public void actionPerformed(ActionEvent arg0) {FrameSpecialScheduleManagementActions.delete(m);}
		});

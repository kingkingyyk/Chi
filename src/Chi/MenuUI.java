...
public class MenuUI extends JFrame {
	...
	public MenuUI() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (diag.OKPressed && JOptionPane.showConfirmDialog(diag,"Confirm to delete all readings of "+diag.selectedSensor+"?","Clear readings",JOptionPane.OK_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE)==JOptionPane.YES_OPTION) {
					...
					Thread t2=new Thread() {
						public void run () {
							String [] s={"We are still working hard...","Looks like you have a lot of data...","It won't take long..."};
		...
		JLabel lblAbout = new JLabel("<html>A program developed by kingkingyyk for Internet of Things monitor, reporting, control & automation.<br><br><br><br><br><br><br><br>You are running on "+Config.VERSION_RELEASE+".<br>Latest update is available on https://github.com/kingkingyyk/Chi</html>");

 ...
 */
public class Controller implements java.io.Serializable, Comparable<Controller> {
	...
	public int compareTo (Controller ctrl) {
		return this.getControllername().compareTo(ctrl.getControllername());
	}
}

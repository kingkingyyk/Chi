...
public class Specialschedule implements java.io.Serializable, Comparable<Specialschedule> {
	...
	public int compareTo(Specialschedule ss) {
		return this.getSchedulename().compareTo(ss.getSchedulename());
	}
}

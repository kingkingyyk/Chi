...
public class DialogReadingExportSelectYearRange extends JDialog {
	...
	public DialogReadingExportSelectYearRange() {
		...
		btnExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if (fc.showSaveDialog(DialogReadingExportSelectYearRange.this)==JFileChooser.APPROVE_OPTION && (!fc.getSelectedFile().exists() || (fc.getSelectedFile().exists() && JOptionPane.showConfirmDialog(null,"Overwrite the file?","Export Yearly Report",JOptionPane.WARNING_MESSAGE)==JOptionPane.OK_OPTION) )) {
				    ...
				    DialogReadingExportSelectYearRange.this.dispose();
			    }
			    fc.setVisible(false);

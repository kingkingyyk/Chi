...
server.controller.password.default=chi-admin
...
server.controller.username.default=chi-admin
...
server.controller.password=chi-admin
...
server.controller.username=chi-admin

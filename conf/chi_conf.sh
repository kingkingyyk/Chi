...
server.database.sql.user.updatepassword.file.default=sql/User/UpdateUserPassword.sql
...
server.database.ip=192.168.0.5
...
server.database.port.default=9042
server.database.sql.createtables.file=sql/Initialization/CreateTables.sql
...
server.database.sql.user.updatepassword.file=sql/User/UpdateUserPassword.sql
server.database.password.default=chi-admin
server.database.sql.controller.queryall.file.default=sql/Controller/QueryAllControllers.sql
server.database.sql.reset.file=sql/Initialization/ResetDB.sql
server.database.sql.sensor.create.file.default=sql/Sensor/InsertSensor.sql
server.database.password=chi-admin
...
server.database.username.default=chi-admin
server.database.ip.default=127.0.0.1
...
server.database.sql.createtables.file.default=sql/Initialization/CreateTables.sql
server.database.sql.init.file.default=sql/Initialization/InitDB.sql
